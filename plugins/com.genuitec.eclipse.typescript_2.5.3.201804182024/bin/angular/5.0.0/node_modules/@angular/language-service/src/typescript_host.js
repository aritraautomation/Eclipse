 ...
 * syntactically incorrect templates.
 */
DummyHtmlParser = (function (_super) {
 ...
 * Avoid loading resources in the language servcie by using a dummy loader.
 */
DummyResourceLoader = (function (_super) {
...
var TypeScriptServiceHost = (function () {
    ...
    Object.defineProperty(TypeScriptServiceHost.prototype, "resolver", {
        ...
        function () {
            ...
            if (!result) {
                ...
                result = this._resolver = new compiler_1.CompileMetadataResolver(config, htmlParser, moduleResolver, this._directiveResolver, pipeResolver, new compiler_1.JitSummaryResolver(), elementSchemaRegistry, directiveNormalizer, new core_1.ɵConsole(), this._staticSymbolCache, this.reflector, function (error, type) { return _this.collectError(error, type && type.filePath); });
            }
            return result;
        },
        enumerable: true,
    ...
    TypeScriptServiceHost.prototype.getSourceFromDeclaration = function (fileName, version, source, span, type, declaration, node, sourceFile) {
        ...
        if (declaration) {
            return {
                ...
                type: type,
                get members() {
                    return language_services_1.getClassMembersFromDeclaration(t.program, t.checker, sourceFile, declaration, t.tsService);
                },
                get query() {
                    if (!queryCache) {
                        var pipes_1 = t.service.getPipesAt(fileName, node.getStart());
                        queryCache = language_services_1.getSymbolQuery(t.program, t.checker, sourceFile, function () { return language_services_1.getPipesTable(sourceFile, t.program, t.checker, pipes_1, t.tsService); }, t.tsService);
                    }
                    return queryCache;
                }
            };
    ...
    /**
       ...
       * containing class.
       */
    TypeScriptServiceHost.getTemplateClassDeclFromNode = /**
       * Given a template string node, see if it is an Angular template string, and if so return the
       * containing class.
       */
