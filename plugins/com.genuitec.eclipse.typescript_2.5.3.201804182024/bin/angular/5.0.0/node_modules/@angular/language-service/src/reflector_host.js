...
ReflectorHost = (function (_super) {
    ...
    function ReflectorHost(getProgram, serviceHost, options) {
        ...
        /* program */ (null), options, new language_services_1.ModuleResolutionHostAdapter(new ReflectorModuleModuleResolutionHost(serviceHost)), { verboseInvalidExpression: true }) || this;
...
}(language_services_1.CompilerHost));
