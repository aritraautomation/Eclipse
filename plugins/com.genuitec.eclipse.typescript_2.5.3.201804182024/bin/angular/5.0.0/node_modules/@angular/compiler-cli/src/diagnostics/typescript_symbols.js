...
}, ɵ1 = function (node) { return !!(node.flags & ts.NodeFlags.Private); };
exports.ɵ0 = ɵ0;
exports.ɵ1 = ɵ1;
...
var isPrivate = ts.ModifierFlags ?
    (ɵ0) :
    (ɵ1);
var ɵ2 = function (type) {
    return !!(type.flags & ts.TypeFlags.Object &&
        type.objectFlags & ts.ObjectFlags.Reference);
}, ɵ3 = function (type) { return !!(type.flags & ts.TypeFlags.Reference); };
exports.ɵ2 = ɵ2;
exports.ɵ3 = ɵ3;
...
var TypeWrapper = (function () {
    ...
    TypeWrapper.prototype.indexed = function (argument) {
        return indexedTypeSymbol(this.tsType, argument.tsType, this.context);
    };
    return TypeWrapper;
}());
...
function indexedTypeSymbol(arr, index, context) {
    if ((index.getFlags() & ts.TypeFlags.StringLike) && arr.getStringIndexType && arr.getStringIndexType()) {
        return new TypeWrapper((arr.getStringIndexType()), context);
    }
    if ((index.getFlags() & ts.TypeFlags.NumberLike) && arr.getNumberIndexType && arr.getNumberIndexType()) {
        return new TypeWrapper((arr.getNumberIndexType()), context);
    }
    return undefined;
}
...
function definitionFromTsSymbol(symbol) {
    ...
    if (declarations) {
        return declarations
            .filter(function (decl) { return !!decl.name; })
...
function documentationFromTsSymbol(symbol, context, ngSymbol) {
    ...
    var declaration = symbol.declarations
        .find(function (decl) { return !!decl.name; });
    if (!declaration) {
        return;
    }
