...
var BaseAotCompilerHost = (function () {
    ...
    BaseAotCompilerHost.prototype.readMetadata = function (dtsFilePath) {
        ...
        try {
            ...
            if (metadatas_1.length) {
                ...
                if (maxMetadata && maxMetadata.version < index_1.METADATA_VERSION) {
    ...
    BaseAotCompilerHost.prototype.upgradeMetadataWithDtsData = function (oldMetadata, dtsFilePath) {
        ...
        var newMetadata = {
            '__symbolic': 'module',
            'version': index_1.METADATA_VERSION,
...
CompilerHost = (function (_super) {
    ...
    /**
       ...
       * NOTE: (*) the relative path is computed depending on `isGenDirChildOfRootDir`.
       */
    CompilerHost.prototype.fileNameToModuleName = /**
       * We want a moduleId that will appear in import statements in the generated code.
       * These need to be in a form that system.js can load, so absolute file paths don't work.
       *
       * The `containingFile` is always in the `genDir`, where as the `importedFile` can be in
    ...
    /**
       * Moves the path into `genDir` folder while preserving the `node_modules` directory.
       */
    CompilerHost.prototype.rewriteGenDirPath = /**
       * Moves the path into `genDir` folder while preserving the `node_modules` directory.
       */
    function (filepath) {
