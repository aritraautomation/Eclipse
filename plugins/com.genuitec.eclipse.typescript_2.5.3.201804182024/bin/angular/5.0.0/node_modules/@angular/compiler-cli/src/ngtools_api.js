 ...
 * passed in the interface.
 */
CustomLoaderModuleResolutionHostAdapter = (function (_super) {
 ...
 * @internal
 */
NgTools_InternalApi_NG_2 = (function () {
    ...
    /**
       * @internal
       */
    NgTools_InternalApi_NG_2.codeGen = /**
       * @internal
       */
    function (options) {
    ...
    /**
       * @internal
       */
    NgTools_InternalApi_NG_2.extractI18n = /**
       * @internal
       */
    function (options) {
        var hostContext = new CustomLoaderModuleResolutionHostAdapter(options.readResource, options.host);
