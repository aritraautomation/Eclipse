...
AstType = (function () {
    ...
    AstType.prototype.resolvePropertyRead = function (receiverType, ast) {
        ...
        // If the type provides indexed access for string, return that type
        if (!member) {
            var indexedType = receiverType.indexed(this.query.getBuiltinType(symbols_1.BuiltinType.String));
            if (indexedType) {
                return indexedType;
            }
        }
