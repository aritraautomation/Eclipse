...
MetadataCollector = (function () {
    ...
    /**
       ...
       * the source file that is expected to correspond to a module.
       */
    MetadataCollector.prototype.getMetadata = /**
       * Returns a JSON.stringify friendly form describing the decorators of the exported classes from
       * the source file that is expected to correspond to a module.
       */
    function (sourceFile, strict, substituteExpression) {
        var _this = this;
                    ...
                    if (moduleSpecifier && moduleSpecifier.kind == ts.SyntaxKind.StringLiteral) {
                        ...
                        if (exportClause) {
                            moduleExport.export = exportClause.elements.map(function (spec) {
                                return spec.propertyName ? { name: spec.propertyName.text, as: spec.name.text } :
                                    spec.name.text;
                            });
                        }
                        if (!exports)
