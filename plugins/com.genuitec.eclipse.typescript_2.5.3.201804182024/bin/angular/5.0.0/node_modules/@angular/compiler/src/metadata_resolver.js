...
CompileMetadataResolver = (function () {
    ...
    CompileMetadataResolver.prototype.getNgModuleMetadata = function (moduleType, throwIfNotFound) {
        ...
        if (meta.entryComponents) {
            flattenAndDedupeArray(meta.entryComponents).forEach(function (type) {
                try {
                    entryComponents.push((_this._getEntryComponentMetadata(type)));
                }
                catch (e) {
                    _this._reportError(e, moduleType);
                }
            });
        }
        if (meta.bootstrap) {
        ...
        bootstrapComponents.forEach(function (type) {
            try {
                entryComponents.push((_this._getEntryComponentMetadata(type.reference)));
            }
            catch (e) {
                _this._reportError(e, moduleType);
            }
