    ...
    StaticReflector.prototype.propMetadata = function (type) {
        ...
        if (!propMetadata) {
            ...
            Object.keys(members_1).forEach(function (propName) {
                ...
                //we might have an attribute decorator in constructor
                var constructorData = propData
                    .find(function (a) { return a['__symbolic'] == 'constructor'; });
                if (constructorData && constructorData['parameterDecorators']) {
                    for (var _i = 0, _a = constructorData['parameterDecorators']; _i < _a.length; _i++) {
                        var paramDecor = _a[_i];
                        if (paramDecor) {
                            decorators.push.apply(decorators, _this.simplify(type, paramDecor));
                        }
                    }
                }
            });
