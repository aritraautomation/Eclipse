...
function checkBindingNoChanges(view, def, bindingIdx, value) {
    ...
    if ((view.state & 1 /* BeforeFirstCheck */) || !change_detection_1.devModeEqual(oldValue, value)) {
        throw errors_1.expressionChangedAfterItHasBeenCheckedError(types_1.Services.createDebugContext(view, def.nodeIndex), oldValue, value, (view.state & 1 /* BeforeFirstCheck */) !== 0);
    }
}
