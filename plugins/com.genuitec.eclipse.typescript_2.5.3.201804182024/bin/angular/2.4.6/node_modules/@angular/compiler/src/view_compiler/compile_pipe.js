...
var CompilePipe = (function () {
    function CompilePipe(view, meta) {
        ...
        var deps = this.meta.type.diDeps.map(function (diDep) {
            if (compile_metadata_1.tokenReference(diDep.token) === identifiers_1.resolveIdentifier(identifiers_1.Identifiers.ChangeDetectorRef)) {
                return util_1.getPropertyInView(o.THIS_EXPR.prop('ref'), _this.view, _this.view.componentView);
            }
            return util_1.injectFromViewParentInjector(view, diDep.token, false);
        });
    ...
    CompilePipe.prototype._call = function (callingView, args) {
        if (this.meta.pure) {
            ...
            identifier_util_1.createPureProxy(pipeInstanceSeenFromPureProxy.prop('transform')
            ...
            return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.castByValue))
