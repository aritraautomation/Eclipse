...
var _TsEmitterVisitor = (function (_super) {
    ...
    _TsEmitterVisitor.prototype.visitLiteralExpr = function (ast, ctx) {
        var value = ast.value;
        if (lang_1.isBlank(value) && ast.type != o.NULL_TYPE) {
    ...
    _TsEmitterVisitor.prototype.visitExpressionType = function (ast, ctx) {
        var _this = this;
        ast.value.visitExpression(this, ctx);
        if (lang_1.isPresent(ast.typeParams) && ast.typeParams.length > 0) {
            ctx.print("<");
    ...
    _TsEmitterVisitor.prototype._visitIdentifier = function (value, typeParams, ctx) {
        var _this = this;
        var name = compile_metadata_1.identifierName(value);
        var moduleUrl = compile_metadata_1.identifierModuleUrl(value);
        if (lang_1.isBlank(name)) {
            throw new Error("Internal error: unknown identifier " + value);
        }
        if (lang_1.isPresent(moduleUrl) && moduleUrl != this._moduleUrl) {
