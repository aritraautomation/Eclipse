...
function identifierName(compileIdentifier) {
    ...
    var identifier = lang_1.stringify(ref);
...
function identifierModuleUrl(compileIdentifier) {
    ...
    return private_import_core_1.reflector.importUri(ref);
}
...
var CompileSummaryKind = exports.CompileSummaryKind;
function tokenName(token) {
    return lang_1.isPresent(token.value) ? _sanitizeIdentifier(token.value) :
        identifierName(token.identifier);
}
exports.tokenName = tokenName;
function tokenReference(token) {
    if (lang_1.isPresent(token.identifier)) {
...
var CompileTemplateMetadata = (function () {
    function CompileTemplateMetadata(_a) {
        ...
        this.animations = animations ? collection_1.ListWrapper.flatten(animations) : [];
