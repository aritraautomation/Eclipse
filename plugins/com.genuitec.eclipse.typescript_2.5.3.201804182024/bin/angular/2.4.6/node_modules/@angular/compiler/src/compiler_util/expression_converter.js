...
function createSharedBindingVariablesIfNeeded(stmts) {
    ...
    if (readVars.has(VAL_UNWRAPPER_VAR.name)) {
        unwrapperStmts.push(VAL_UNWRAPPER_VAR
            .set(o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.ValueUnwrapper)).instantiate([]))
            .toDeclStmt(null, [o.StmtModifier.Final]));
    }
    return unwrapperStmts;
}
exports.createSharedBindingVariablesIfNeeded = createSharedBindingVariablesIfNeeded;
...
var _AstToIrVisitor = (function () {
    ...
    _AstToIrVisitor.prototype.visitInterpolation = function (ast, mode) {
        ...
        return ast.expressions.length <= 9 ?
            o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.inlineInterpolate)).callFn(args) :
            o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.interpolate)).callFn([
...
function createCachedLiteralArray(builder, values) {
    if (values.length === 0) {
        return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.EMPTY_ARRAY));
    }
    ...
    identifier_util_1.createPureProxy(o.fn(proxyParams, [new o.ReturnStatement(o.literalArr(proxyReturnEntries))], new o.ArrayType(o.DYNAMIC_TYPE)), values.length, proxyExpr, builder);
    return proxyExpr.callFn(values);
}
function createCachedLiteralMap(builder, entries) {
    if (entries.length === 0) {
        return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.EMPTY_MAP));
    }
    ...
    identifier_util_1.createPureProxy(o.fn(proxyParams, [new o.ReturnStatement(o.literalMap(proxyReturnEntries))], new o.MapType(o.DYNAMIC_TYPE)), entries.length, proxyExpr, builder);
    return proxyExpr.callFn(values);
}
