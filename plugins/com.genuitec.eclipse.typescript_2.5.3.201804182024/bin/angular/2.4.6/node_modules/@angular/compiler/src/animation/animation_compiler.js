...
exports.AnimationEntryCompileResult = AnimationEntryCompileResult;
...
var _AnimationBuilder = (function () {
    ...
    _AnimationBuilder.prototype.visitAnimationStyles = function (ast, context) {
        ...
        return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationStyles)).instantiate([
            o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.collectAndResolveStyles)).callFn([
                _ANIMATION_COLLECTED_STYLES, o.literalArr(stylesArr)
            ])
        ]);
    };
    _AnimationBuilder.prototype.visitAnimationKeyframe = function (ast, context) {
        return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationKeyframe)).instantiate([
    ...
    _AnimationBuilder.prototype._visitEndStateAnimation = function (ast, context) {
        ...
        var keyframesExpr = o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.balanceAnimationKeyframes)).callFn([
    ...
    _AnimationBuilder.prototype.visitAnimationSequence = function (ast, context) {
        ...
        return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationSequencePlayer)).instantiate([
    ...
    _AnimationBuilder.prototype.visitAnimationGroup = function (ast, context) {
        var _this = this;
        var playerExprs = ast.steps.map(function (step) { return step.visit(_this, context); });
        return o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationGroupPlayer)).instantiate([
            o.literalArr(playerExprs)
        ]);
    };
    ...
    _AnimationBuilder.prototype.visitAnimationStateTransition = function (ast, context) {
        ...
        ast.stateChanges.forEach(function (stateChange) {
            ...
            if (stateChange.fromState != private_import_core_1.ANY_STATE) {
                context.stateMap.registerState(stateChange.fromState);
            }
            if (stateChange.toState != private_import_core_1.ANY_STATE) {
    ...
    _AnimationBuilder.prototype.visitAnimationEntry = function (ast, context) {
        ...
        context.stateMap.registerState(private_import_core_1.DEFAULT_STATE, {});
        var statements = [];
        statements.push(_PREVIOUS_ANIMATION_PLAYERS
            .set(_ANIMATION_FACTORY_VIEW_CONTEXT.callMethod('getAnimationPlayers', [
            _ANIMATION_FACTORY_ELEMENT_VAR,
            _ANIMATION_NEXT_STATE_VAR.equals(o.literal(private_import_core_1.EMPTY_STATE))
        ...
        statements.push(_ANIMATION_DEFAULT_STATE_VAR.set(this._statesMapVar.key(o.literal(private_import_core_1.DEFAULT_STATE)))
            .toDeclStmt());
        ...
        var RENDER_STYLES_FN = o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.renderStyles));
        ...
        statements.push(new o.IfStmt(_ANIMATION_PLAYER_VAR.equals(o.NULL_EXPR), [_ANIMATION_PLAYER_VAR
                .set(o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.NoOpAnimationPlayer)).instantiate([]))
                .toStmt()]));
        ...
        statements.push(_ANIMATION_PLAYER_VAR
            .callMethod('onDone', [o
                ...
                RENDER_STYLES_FN
                    ...
                    o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.prepareFinalAnimationStyles))
                        .callFn([
            ...
            .toStmt());
        statements.push(o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationSequencePlayer))
        ...
        statements.push(RENDER_STYLES_FN
            .callFn([
            _ANIMATION_FACTORY_ELEMENT_VAR, _ANIMATION_FACTORY_RENDERER_VAR,
            o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.clearStyles))
        ...
        statements.push(_ANIMATION_FACTORY_VIEW_CONTEXT
            ...
            .toStmt());
        statements.push(new o.ReturnStatement(o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationTransition)).instantiate([
            _ANIMATION_PLAYER_VAR, _ANIMATION_CURRENT_STATE_VAR, _ANIMATION_NEXT_STATE_VAR,
            _ANIMATION_TIME_VAR
        ])));
        return o.fn([
            new o.FnParam(_ANIMATION_FACTORY_VIEW_VAR.name, o.importType(identifiers_1.createIdentifier(identifiers_1.Identifiers.AppView), [o.DYNAMIC_TYPE])),
            new o.FnParam(_ANIMATION_FACTORY_ELEMENT_VAR.name, o.DYNAMIC_TYPE),
            new o.FnParam(_ANIMATION_CURRENT_STATE_VAR.name, o.DYNAMIC_TYPE),
            new o.FnParam(_ANIMATION_NEXT_STATE_VAR.name, o.DYNAMIC_TYPE)
        ], statements, o.importType(identifiers_1.createIdentifier(identifiers_1.Identifiers.AnimationTransition)));
    };
    _AnimationBuilder.prototype.build = function (ast) {
        ...
        var compiledStatesMapStmt = this._statesMapVar.set(o.literalMap(lookupMap, null, true)).toDeclStmt();
...
function _compareToAnimationStateExpr(value, animationState) {
    var emptyStateLiteral = o.literal(private_import_core_1.EMPTY_STATE);
    switch (animationState) {
        case private_import_core_1.EMPTY_STATE:
            return value.equals(emptyStateLiteral);
        case private_import_core_1.ANY_STATE:
