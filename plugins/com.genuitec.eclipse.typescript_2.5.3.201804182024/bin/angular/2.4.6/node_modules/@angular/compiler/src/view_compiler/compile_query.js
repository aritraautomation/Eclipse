...
function createQueryList(propertyName, compileView) {
    compileView.fields.push(new o.ClassField(propertyName, o.importType(identifiers_1.createIdentifier(identifiers_1.Identifiers.QueryList), [o.DYNAMIC_TYPE])));
    var expr = o.THIS_EXPR.prop(propertyName);
    compileView.createMethod.addStmt(o.THIS_EXPR.prop(propertyName)
        .set(o.importExpr(identifiers_1.createIdentifier(identifiers_1.Identifiers.QueryList), [o.DYNAMIC_TYPE]).instantiate([]))
        .toStmt());
    return expr;
}
...
function addQueryToTokenMap(map, query) {
    query.meta.selectors.forEach(function (selector) {
        var entry = map.get(compile_metadata_1.tokenReference(selector));
        if (!entry) {
            entry = [];
            map.set(compile_metadata_1.tokenReference(selector), entry);
        }
        entry.push(query);
    });
}
