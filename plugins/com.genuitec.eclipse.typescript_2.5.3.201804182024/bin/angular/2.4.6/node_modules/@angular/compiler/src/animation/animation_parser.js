...
exports.AnimationEntryParseResult = AnimationEntryParseResult;
var AnimationParser = (function () {
    ...
    AnimationParser.prototype.parseComponent = function (component) {
        var _this = this;
        var errors = [];
        var componentName = compile_metadata_1.identifierName(component.type);
    ...
    AnimationParser = __decorate([
        ...
        __metadata('design:paramtypes', [element_schema_registry_1.ElementSchemaRegistry])
    ], AnimationParser);
...
function _parseAnimationDeclarationStates(stateMetadata, schema, errors) {
    ...
    var defStyles = new animation_ast_1.AnimationStylesAst(normalizedStyles);
...
function _parseAnimationStateTransition(transitionStateMetadata, stateStyles, schema, errors) {
    ...
    var stepsAst = (animationAst instanceof animation_ast_1.AnimationWithStepsAst) ?
        animationAst :
        new animation_ast_1.AnimationSequenceAst([animationAst]);
    return new animation_ast_1.AnimationStateTransitionAst(transitionExprs, stepsAst);
}
...
function _parseAnimationTransitionExpr(eventStr, errors) {
    ...
    var isFullAnyStateExpr = fromState == private_import_core_1.ANY_STATE && toState == private_import_core_1.ANY_STATE;
...
function _normalizeAnimationEntry(entry) {
    return Array.isArray(entry) ? new compile_metadata_1.CompileAnimationSequenceMetadata(entry) : entry;
}
...
function _normalizeStyleSteps(entry, stateStyles, schema, errors) {
    ...
    return (entry instanceof compile_metadata_1.CompileAnimationGroupMetadata) ?
        new compile_metadata_1.CompileAnimationGroupMetadata(steps) :
        new compile_metadata_1.CompileAnimationSequenceMetadata(steps);
}
    ...
    for (var i = 1; i <= limit; i++) {
        ...
        Object.keys(styles).forEach(function (prop) {
            if (!lang_1.isPresent(firstKeyframeStyles[prop])) {
                firstKeyframeStyles[prop] = private_import_core_1.FILL_STYLE_FLAG;
            }
        });
    }
...
function _parseTransitionAnimation(entry, currentTime, collectedStyles, stateStyles, errors) {
    ...
    if (entry instanceof compile_metadata_1.CompileAnimationWithStepsMetadata) {
        var maxDuration_1 = 0;
        var steps_1 = [];
        var isGroup_1 = entry instanceof compile_metadata_1.CompileAnimationGroupMetadata;
        ...
        entry.steps.forEach(function (entry) {
            ...
            if (lang_1.isPresent(previousStyles_1)) {
                if (entry instanceof compile_metadata_1.CompileAnimationWithStepsMetadata) {
                    var startingStyles = new animation_ast_1.AnimationStylesAst(previousStyles_1);
                    steps_1.push(new animation_ast_1.AnimationStepAst(startingStyles, [], 0, 0, ''));
                }
                else {
        ...
        if (isGroup_1) {
            ast = new animation_ast_1.AnimationGroupAst(steps_1);
            playTime = maxDuration_1;
            currentTime = startingTime + playTime;
        }
        else {
            ast = new animation_ast_1.AnimationSequenceAst(steps_1);
        }
    }
    ...
    endKeyframe.styles.styles.forEach(function (styleData) {
        Object.keys(styleData).forEach(function (prop) {
            ...
            if (lang_1.isPresent(resultIndex)) {
                ...
                value = private_import_core_1.FILL_STYLE_FLAG;
            }
