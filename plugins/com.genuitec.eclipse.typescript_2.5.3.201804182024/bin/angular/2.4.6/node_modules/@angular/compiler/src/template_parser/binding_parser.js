...
})(exports.BoundPropertyType || (exports.BoundPropertyType = {}));
var BoundPropertyType = exports.BoundPropertyType;
/**
...
var BindingParser = (function () {
        ...
        if (_isAnimationLabel(name)) {
            ...
            if (value) {
                this._reportError("Assigning animation triggers via @prop=\"exp\" attributes with an expression is invalid." +
                    " Use property bindings (e.g. [@prop]=\"exp\") or use an attribute without a value (e.g. @prop) instead.", sourceSpan, parse_util_1.ParseErrorLevel.FATAL);
            }
    ...
    BindingParser.prototype.createElementPropertyAst = function (elementSelector, boundProp) {
        if (boundProp.isAnimation) {
            return new template_ast_1.BoundElementPropertyAst(boundProp.name, template_ast_1.PropertyBindingType.Animation, core_1.SecurityContext.NONE, false, boundProp.expression, null, boundProp.sourceSpan);
        }
        var unit = null;
        var bindingType;
        ...
        return new template_ast_1.BoundElementPropertyAst(boundPropertyName, bindingType, securityContexts.length === 1 ? securityContexts[0] : null, securityContexts.length > 1, boundProp.expression, unit, boundProp.sourceSpan);
    };
    ...
    BindingParser.prototype._validatePropertyOrAttributeName = function (propName, sourceSpan, isAttr) {
        ...
        if (report.error) {
            this._reportError(report.msg, sourceSpan, parse_util_1.ParseErrorLevel.FATAL);
        }
    };
