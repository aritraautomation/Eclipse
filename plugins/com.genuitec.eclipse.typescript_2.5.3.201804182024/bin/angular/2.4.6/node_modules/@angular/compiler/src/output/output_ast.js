...
exports.NULL_TYPE = new BuiltinType(BuiltinTypeName.Null);
///// Expressions
...
var Expression = (function () {
    ...
    Expression.prototype.isBlank = function () {
        ...
        return this.equals(exports.TYPED_NULL_EXPR);
    };
...
exports.TYPED_NULL_EXPR = new LiteralExpr(null, exports.NULL_TYPE);
//// Statements
...
function importType(id, typeParams, typeModifiers) {
    ...
    return lang_1.isPresent(id) ? expressionType(importExpr(id), typeParams, typeModifiers) : null;
}
exports.importType = importType;
function expressionType(expr, typeParams, typeModifiers) {
    if (typeParams === void 0) { typeParams = null; }
    if (typeModifiers === void 0) { typeModifiers = null; }
    return lang_1.isPresent(expr) ? new ExpressionType(expr, typeParams, typeModifiers) : null;
}
exports.expressionType = expressionType;
