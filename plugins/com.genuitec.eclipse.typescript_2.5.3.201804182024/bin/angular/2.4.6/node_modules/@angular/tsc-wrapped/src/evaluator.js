    ...
    Evaluator.prototype.evaluateNode = function (node) {
        ...
        switch (node.kind) {
            ...
            case ts.SyntaxKind.CallExpression:
                ...
                var args = callExpression.arguments.map(function (arg) { return _this.evaluateNode(arg); });
            ...
            case ts.SyntaxKind.PropertyAccessExpression: {
                ...
                if (isMetadataError(expression_1)) {
            ...
            case ts.SyntaxKind.ElementAccessExpression: {
                ...
                if (isMetadataError(expression_2)) {
            ...
            case ts.SyntaxKind.TypeReference:
                ...
                var getReference = function (node) {
                    if (typeNameNode_1.kind === ts.SyntaxKind.QualifiedName) {
                        ...
                        if (isMetadataError(symbol) || schema_1.isMetadataSymbolicReferenceExpression(symbol)) {
