 ...
 */
"use strict";
var animation_queue_1 = require('../animation/animation_queue');
...
var ViewUtils = (function () {
    ...
    ViewUtils.ctorParameters = function () { return [
        ...
        { type: animation_queue_1.AnimationQueue, },
    ]; };
    return ViewUtils;
}());
...
function createRenderComponentType(templateUrl, slotCount, encapsulation, styles, animations) {
    return new api_1.RenderComponentType("" + nextRenderComponentTypeId++, templateUrl, slotCount, encapsulation, styles, animations);
}
exports.createRenderComponentType = createRenderComponentType;
...
exports.setBindingDebugInfoForChanges = setBindingDebugInfoForChanges;
...
exports.setBindingDebugInfo = setBindingDebugInfo;
...
function selectOrCreateRenderHostElement(renderer, elementName, attrs, rootSelectorOrNode, debugInfo) {
    ...
    if (lang_1.isPresent(rootSelectorOrNode)) {
        ...
        renderer.setElementAttribute(hostElement, 'ng-version', version_1.VERSION.full);
    }
    else {
...
exports.selectOrCreateRenderHostElement = selectOrCreateRenderHostElement;
...
exports.subscribeToRenderElement = subscribeToRenderElement;
...
exports.InlineArray2 = InlineArray2;
...
exports.InlineArray4 = InlineArray4;
...
exports.InlineArray8 = InlineArray8;
...
exports.InlineArray16 = InlineArray16;
...
exports.InlineArrayDynamic = InlineArrayDynamic;
exports.EMPTY_INLINE_ARRAY = new InlineArray0();
