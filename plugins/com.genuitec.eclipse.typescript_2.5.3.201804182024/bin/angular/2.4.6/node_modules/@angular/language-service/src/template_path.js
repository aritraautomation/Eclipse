    ...
    TemplateAstChildVisitor.prototype.visitChildren = function (context, cb) {
        ...
        function visit(children) {
            if (children && children.length)
                results.push(template_ast_1.templateVisitAll(visitor, children, context));
        }
        cb(visit);
...
exports.TemplateAstChildVisitor = TemplateAstChildVisitor;
var TemplateAstPathBuilder = (function (_super) {
    ...
    TemplateAstPathBuilder.prototype.visit = function (ast, context) {
        ...
        if (utils_1.inSpan(this.position, span)) {
            var len = this.path.length;
            if (!len || this.allowWidening || utils_1.isNarrower(span, utils_1.spanOf(this.path[len - 1]))) {
                this.path.push(ast);
            }
        }
        else {
