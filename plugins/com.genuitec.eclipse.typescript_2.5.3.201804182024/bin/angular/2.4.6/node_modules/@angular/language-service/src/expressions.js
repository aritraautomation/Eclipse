...
var AstType = (function () {
    ...
    AstType.prototype.visitBinary = function (ast) {
        ...
        function normalize(kind, other) {
            switch (kind) {
                ...
                case types_1.BuiltinType.Null:
                    return normalize(other, types_1.BuiltinType.Other);
            }
            return kind;
        }
        ...
        switch (ast.operation) {
            ...
            case '|':
                switch (operKind) {
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Number:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Number:
                        return this.query.getBuiltinType(types_1.BuiltinType.Number);
                    default:
            ...
            case '+':
                switch (operKind) {
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Boolean:
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Number:
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Other:
                    case types_1.BuiltinType.Boolean << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Other << 8 | types_1.BuiltinType.Any:
                        return this.anyType;
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.String:
                    case types_1.BuiltinType.Boolean << 8 | types_1.BuiltinType.String:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.String:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.Boolean:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.Number:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.String:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.Other:
                    case types_1.BuiltinType.Other << 8 | types_1.BuiltinType.String:
                        return this.query.getBuiltinType(types_1.BuiltinType.String);
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Number:
                        return this.query.getBuiltinType(types_1.BuiltinType.Number);
                    case types_1.BuiltinType.Boolean << 8 | types_1.BuiltinType.Number:
                    case types_1.BuiltinType.Other << 8 | types_1.BuiltinType.Number:
                        return this.reportError('Expected a number type', ast.left);
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Boolean:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Other:
            ...
            case '!==':
                switch (operKind) {
                    ...
                    case types_1.BuiltinType.Any << 8 | types_1.BuiltinType.Other:
                    case types_1.BuiltinType.Boolean << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Boolean << 8 | types_1.BuiltinType.Boolean:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Number << 8 | types_1.BuiltinType.Number:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.String << 8 | types_1.BuiltinType.String:
                    case types_1.BuiltinType.Other << 8 | types_1.BuiltinType.Any:
                    case types_1.BuiltinType.Other << 8 | types_1.BuiltinType.Other:
                        return this.query.getBuiltinType(types_1.BuiltinType.Boolean);
                    default:
    ...
    AstType.prototype.visitChain = function (ast) {
        ...
        return this.query.getBuiltinType(types_1.BuiltinType.Undefined);
    };
    ...
    AstType.prototype.visitLiteralPrimitive = function (ast) {
        ...
        switch (ast.value) {
            ...
            case false:
                return this.query.getBuiltinType(types_1.BuiltinType.Boolean);
            case null:
                return this.query.getBuiltinType(types_1.BuiltinType.Null);
            case undefined:
                return this.query.getBuiltinType(types_1.BuiltinType.Undefined);
            default:
    ...
    AstType.prototype.visitQuote = function (ast) {
        ...
        return this.query.getBuiltinType(types_1.BuiltinType.Any);
    };
    ...
    Object.defineProperty(AstType.prototype, "anyType", {
        get: function () {
            ...
            if (!result) {
                result = this._anyType = this.query.getBuiltinType(types_1.BuiltinType.Any);
            }
            return result;
        },
        enumerable: true,
    ...
    Object.defineProperty(AstType.prototype, "undefinedType", {
        get: function () {
            ...
            if (!result) {
                result = this._undefinedType = this.query.getBuiltinType(types_1.BuiltinType.Undefined);
            }
            return result;
        },
        enumerable: true,
    ...
    AstType.prototype.reportError = function (message, ast) {
        if (this.diagnostics) {
            this.diagnostics.push(new TypeDiagnostic(types_1.DiagnosticKind.Error, message, ast));
        }
        return this.anyType;
    };
    AstType.prototype.reportWarning = function (message, ast) {
        if (this.diagnostics) {
            this.diagnostics.push(new TypeDiagnostic(types_1.DiagnosticKind.Warning, message, ast));
        }
        return this.anyType;
    };
    AstType.prototype.isAny = function (symbol) {
        return !symbol || this.query.getTypeKind(symbol) == types_1.BuiltinType.Any ||
...
var AstPathVisitor = (function (_super) {
    ...
    AstPathVisitor.prototype.visit = function (ast) {
        if ((!this.excludeEmpty || ast.span.start < ast.span.end) && utils_1.inSpan(this.position, ast.span)) {
            this.path.push(ast);
            visitChildren(ast, this);
        }
    };
...
function getEventDeclaration(info, path, includeEvent) {
    ...
    if (includeEvent) {
        ...
        result = [{
                name: '$event',
                kind: 'variable',
                type: info.template.query.getBuiltinType(types_1.BuiltinType.Any)
            }];
    }
    return result;
}
function getReferences(info) {
    ...
    function processReferences(references) {
        var _loop_1 = function(reference) {
            var type = void 0;
            if (reference.value) {
                type = info.template.query.getTypeSymbol(compiler_1.tokenReference(reference.value));
            }
            result.push({
                name: reference.name,
                kind: 'reference',
                type: type || info.template.query.getBuiltinType(types_1.BuiltinType.Any),
                get definition() { return getDefintionOf(info, reference, "alias", reference.name); }
            });
        };
        ...
        if (current instanceof template_ast_1.EmbeddedTemplateAst) {
            var _loop_2 = function(variable) {
                ...
                if (context) {
                    ...
                    if (value) {
                        type = value.type;
                        if (info.template.query.getTypeKind(type) === types_1.BuiltinType.Any) {
                ...
                result.push({
                    name: name_1,
                    kind: 'variable', type: type, get definition() { return getDefintionOf(info, variable, 'var', name_1); }
                });
            };
...
function refinedVariableType(type, info, templateElement) {
    ...
    var ngForDirective = templateElement.directives.find(function (d) { return compiler_1.identifierName(d.directive.type) == 'NgFor'; });
    if (ngForDirective) {
