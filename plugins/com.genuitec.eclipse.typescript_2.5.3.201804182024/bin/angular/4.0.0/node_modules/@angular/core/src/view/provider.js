        ...
        if (elDef) {
            switch (tokenKey) {
                ...
                case ElementRefTokenKey:
                    return new element_ref_1.ElementRef(types_1.asElementData(view, elDef.nodeIndex).renderElement);
                case ViewContainerRefTokenKey:
                    return types_1.asElementData(view, elDef.nodeIndex).viewContainer;
                case TemplateRefTokenKey: {
                    if (elDef.element.template) {
                        return types_1.asElementData(view, elDef.nodeIndex).template;
                    }
                    break;
                }
                ...
                default:
                    ...
                    if (providerDef_1) {
                        var providerData = types_1.asProviderData(view, providerDef_1.nodeIndex);
