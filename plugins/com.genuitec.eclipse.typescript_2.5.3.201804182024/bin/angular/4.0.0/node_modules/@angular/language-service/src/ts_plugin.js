...
function create(info /* ts.server.PluginCreateInfo */) {
    ...
    var serviceHost = new typescript_host_1.TypeScriptServiceHost(info.languageServiceHost, info.languageService, null);
    ...
    proxy.getSemanticDiagnostics = function (fileName) {
        ...
        tryOperation('get diagnostics', function () {
            ...
            var ours = ls.getDiagnostics(fileName).get(fileName);
            if (ours && ours.length) {
